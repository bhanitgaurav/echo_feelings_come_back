...
const PrivacyPolicy = () => {
    ...
    useEffect(() => {
        const fetchContent = async () => {
            try {
                ...
                setError('Unable to load privacy policy at this time.');
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="section-container">
            <SEO title="Privacy Policy" description="Learn how Echo protects your data and ensures anonymity." />
            <div className="container" style={{ maxWidth: '800px' }}>
                ...
                <div className="card glass-card" style={{ marginTop: '30px', textAlign: 'center' }}>
                    <h3 style={{ marginBottom: '16px' }}>Contact Us</h3>
                    <p>If you have questions, please contact us through the <Link to="/#support">support form</Link>.</p>
                </div>
            </div>
            <style>{`
                 .legal-content {
